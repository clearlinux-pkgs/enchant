...
Source0  : https://github.com/AbiWord/enchant/releases/download/v2.6.8/enchant-2.6.8.tar.gz
...
%prep
%setup -q -n enchant-2.6.8
cd %{_builddir}/enchant-2.6.8
pushd ..
cp -a enchant-2.6.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711385024
