...
Source0  : https://github.com/AbiWord/enchant/releases/download/v2.3.3/enchant-2.3.3.tar.gz
...
%prep
%setup -q -n enchant-2.3.3
cd %{_builddir}/enchant-2.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650419138
...
cp %{_builddir}/enchant-2.3.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/enchant/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
...
/usr/lib64/libenchant-2.so.2.3.3
