...
Source0  : https://github.com/AbiWord/enchant/releases/download/v2.2.4/enchant-2.2.4.tar.gz
Summary  : A wrapper library for generic spell checking
...
export LANG=C
export SOURCE_DATE_EPOCH=1560868089
...
cp COPYING.LIB %{buildroot}/usr/share/package-licenses/enchant/COPYING.LIB
%make_install
...
/usr/lib64/libenchant-2.so.2.2.4

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/enchant/COPYING.LIB
