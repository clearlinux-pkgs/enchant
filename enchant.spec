...
Source0  : https://github.com/AbiWord/enchant/releases/download/v2.6.6/enchant-2.6.6.tar.gz
...
%prep
%setup -q -n enchant-2.6.6
cd %{_builddir}/enchant-2.6.6
pushd ..
cp -a enchant-2.6.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707159991
