...
Source0  : https://github.com/AbiWord/enchant/releases/download/v2.3.1/enchant-2.3.1.tar.gz
...
%prep
%setup -q -n enchant-2.3.1
cd %{_builddir}/enchant-2.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629501770
...
cp %{_builddir}/enchant-2.3.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/enchant/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
...
/usr/lib64/libenchant-2.so.2.3.1
